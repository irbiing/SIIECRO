                    ...
                    <div align="center">
                        <table style="width: 50%"  border="0">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="temporada_trabajo" class="form-control" value="{{$a_cientifico->temporada_trabajo}}" style="width:500px; text-align:center;" readonly></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-control"  name="nomenclatura_muestra" value="{{$a_cientifico->nomenclatura_muestra}}" style="width:500px; text-align:center;" ></td>
                            </tr>
                            <tr>
                                <td><label for="lugar_de_resguardo" class="input-group-addon">Lugar de Resguardo</label></td>
                                <td><input type="text" class="form-control"  name="lugar_de_resguardo" value="{{$a_cientifico->lugar_de_resguardo}}" style="width:500px; text-align:center;" ></td>
                            </tr>
                            <tr>
                                <td><label for="caracte_analisis" class="input-group-addon">Caracterización de analisis</label></td>
                                <td><input type="text" class="form-control"  name="caracte_analisis" value="{{$a_cientifico->caracte_analisis}}" style="width:500px; text-align:center;" ></td>
                            </tr>
                            <tr>
                                <td style="text-align:center;"><i class="fa fa-calendar" > Fecha de análisis cientifico</i></td>
                                <td><input type="date" class="form-control date" name="fecha_analisis_cientifico" value="{{$a_cientifico->fecha_analisis_cientifico}}" style="width:500px; text-align:center;" ></td>
                            </tr>
                            <tr>
                                <td><label for="profesor_responsable" class="input-group-addon">Profesor responsable</label></td>
                                <td><input type="text" class="form-control"  name="profesor_responsable" value="{{$a_cientifico->profesor_responsable}}" style="width:500px; text-align:center;" ></td>
                            </tr>
                            <tr>
                                <td><label for="persona_realizo_analisis" class="input-group-addon">Persona que realizo el análisis</label></td>
                                <td><input type="text" class="form-control"  name="persona_realizo_analisis" value="{{$a_cientifico->persona_realizo_analisis}}" style="width:500px; text-align:center;" ></td>
                            </tr>
                            <tr>
                                <td><label for="forma_obtencion_muestra" class="input-group-addon">Forma de obtencián de las muestras</label></td>
                                <td><input type="text" class="form-control"  name="forma_obtencion_muestra" value="{{$a_cientifico->forma_obtencion_muestra}}" style="width:500px; text-align:center;" ></td>
                            </tr>
                            <tr>
                                <td><label for="esquema" class="input-group-addon">Esquema</label></td>
                                <td><input type="file" class="form-control"  name="esquema" value="{{$a_cientifico->esquema}}" style="width:500px; text-align:center;" ></td>
                            </tr>
                            <tr>
                                <td><label for="indicaciones" class="input-group-addon">Indicaciones</label></td>
                                <td><input type="text" class="form-control"  name="indicaciones" value="{{$a_cientifico->indicaciones}}" style="width:500px; text-align:center;" ></td>
                            </tr>
                            <tr>
                                <td><label for="tipo_material" class="input-group-addon">Tipo de material</label></td>
                                <td><input type="text" class="form-control"  name="tipo_material" value="{{$a_cientifico->tipo_material}}" style="width:500px; text-align:center;" ></td>
                            </tr>
                            <tr>
                                <td><label for="descripcion" class="input-group-addon">Descripción</label></td>
                                <td><input type="text" class="form-control"  name="descripcion" value="{{$a_cientifico->descripcion}}" style="width:500px; text-align:center;" ></td>
                            </tr>
                            <tr>
                                <td><label for="microfotografia" class="input-group-addon">Microfotografía</label></td>
                                <td><input type="file" class="form-control"  name="microfotografia" value="{{$a_cientifico->microfotografia}}" style="width:500px; text-align:center;" ></td>
                            </tr>
                            <tr>
                                <td><label for="info_definir" class="input-group-addon">Información por definir</label></td>
                                <td><input type="text" class="form-control"  name="info_definir" value="{{$a_cientifico->info_definir}}" style="width:500px; text-align:center;" ></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-control"  name="analisis_morfologico" value="{{$a_cientifico->analisis_morfologico}}" style="width:500px; text-align:center;" ></td>
                            </tr>
                            <tr>
                                <td><label for="analisis_microquimico" class="input-group-addon">Análisis microquímico</label></td>
                                <td><input type="text" class="form-control"  name="analisis_microquimico" value="{{$a_cientifico->analisis_microquimico}}" style="width:500px; text-align:center;" ></td>
                            </tr>
                            <tr>
                                <td><label for="analisis_elemental" class="input-group-addon">Análisis microelemental</label></td>
                                <td><input type="text" class="form-control"  name="analisis_elemental" value="{{$a_cientifico->analisis_elemental}}" style="width:500px; text-align:center;" ></td>
                            </tr>
                            <tr>
                                <td><label for="analisis_molecular" class="input-group-addon">Análisis molecular</label></td>
                                <td><input type="text" class="form-control"  name="analisis_molecular" value="{{$a_cientifico->analisis_molecular}}" style="width:500px; text-align:center;" ></td>
                            </tr>
                            <tr>
                                <td><label for="analisis_de_tincion" class="input-group-addon">Análisis de tinción</label></td>
                                <td><input type="text" class="form-control"  name="analisis_de_tincion" value="{{$a_cientifico->analisis_de_tincion}}" style="width:500px; text-align:center;" ></td>
                            </tr>
                            <tr>
                                <td><label for="analisis_microbiologicos" class="input-group-addon">Análisis Microbiológicos</label></td>
                                <td><input type="text" class="form-control"  name="analisis_microbiologicos" value="{{$a_cientifico->analisis_microbiologicos}}" style="width:500px; text-align:center;" ></td>
                            </tr>
                            <tr>
                                <td><label for="otros" class="input-group-addon">Otros</label></td>
                                <td><input type="text" class="form-control"  name="otros" value="{{$a_cientifico->otros}}" style="width:500px; text-align:center;" ></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-control"  name="resultado_conclucion_general" value="{{$a_cientifico->resultado_conclucion_general}}" style="width:500px; text-align:center;" ></td>
                            </tr>
                            <tr>
                                <td><label for="interpretacion_particular" class="input-group-addon">Interpretación Particular</label></td>
                                <td><input type="text" class="form-control"  name="interpretacion_particular" value="{{$a_cientifico->interpretacion_particular}}" style="width:500px; text-align:center;" ></td>
                            </tr>
                        </table>
                    </div> 
                    <br><br>  
