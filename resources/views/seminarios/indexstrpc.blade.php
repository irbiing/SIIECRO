				...
				<table id="tablaObras" class="table table-hover" role="grid" >
					<thead >
       				...
       				<tbody>
       					...
       					@if($Obra->sector_obra == 'Seminario Taller de Restauración de Pintura de Caballete' || $Obra->sector_obra == 'Servicio Social - Seminario Taller de Restauración de Pintura de Caballete' || $Obra->sector_obra == 'Práctica de Campo - Seminario Taller de Restauración de Pintura de Caballete' )
