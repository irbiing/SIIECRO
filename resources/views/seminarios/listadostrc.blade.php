...
<div class="box">
	<div class="box-body">
		<div class="panel">
			...
			{{ Form::open(['route' => 'lista.strc', 'method' => 'GET', 'class' => 'form-inline pull-right']) }}
				...
				<table id="tablaObras" class="table table-hover" role="grid" align="center">
					<thead >
       				...
       				<tbody>
       					...
       					@if($analisg->sector_obra == 'Seminario Taller de Restauración de Cerámica' || $analisg->sector_obra == 'Servicio Social - Seminario Taller de Restauración de Cerámica' || $analisg->sector_obra == 'Práctica de Campo - Seminario Taller de Restauración de Cerámica' )
       					<tr align="center">
