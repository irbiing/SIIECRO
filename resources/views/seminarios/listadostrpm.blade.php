				...
				<table id="tablaObras" class="table table-hover" role="grid" align="center">
					<thead >
       				...
       				<tbody>
       					...
       					@if($analisg->sector_obra == 'Seminario Taller de Restauración de Pintura Mural' || $analisg->sector_obra == 'Servicio Social - Seminario Taller de Restauración de Pintura Mural' || $analisg->sector_obra == 'Práctica de Campo - Seminario Taller de Restauración de Pintura Mural' )
       					<tr align="center">
